...
export function createInMemoryStorage(
  ...
  return Effect.gen(function* () {
    ...
    const ref =
      stateRef ?? (yield* Ref.make<InMemoryStorageState>({ data: new Map() }));
    ...
    return {
      ...
      deleteAll: () => Ref.set(ref, { data: new Map() }),
 ...
 */
export function createInMemoryStorageWithErrors(errorConfig: {
  failOn?: {
