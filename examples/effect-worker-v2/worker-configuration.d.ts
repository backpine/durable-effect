/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: 91d8f4a2f37c1d6ca2828033f93d00a2)
// Runtime types generated with workerd@1.20251213.0 2024-11-27 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "Jobs" | "Workflows";
	}
	interface Env {
		ENVIRONMENT: "production";
		LOG_LEVEL: "info";
		JOBS: DurableObjectNamespace<import("./src/worker").Jobs>;
		WORKFLOWS: DurableObjectNamespace<import("./src/worker").Workflows>;
		MY_BUCKET: R2Bucket;
	}
}
